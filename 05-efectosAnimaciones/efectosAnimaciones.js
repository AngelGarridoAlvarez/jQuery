...
$(document).ready(function () {
    ...
    //## 1. Métodos .hide y .show - efecto ampliar, reducir
    let caja = $('#caja');
    ...
    //## 2. Métodos .fadeIn(velocidad), .fadeOut(velocidad), fadeTo(velocidad, opacidad) - slideUp/slideDown
    let caja2 = $('#caja2');
    ...
    //## 3. Métodos para un único botón: toggle(velocidad)/fadeToggle /slideToggle/
    ...
    // * para poder incluir color en nuestras animaciones hemos tenido que incluir la librería jQueriUI en nuestro html:
